...
public class ConstantLib {
    ...
    public static final int MOVE_BACK_TIME = 10;
    public static final int WAIT_FOR_SEQUENCE = 100;
    public static final int BOARD_OPERATE_TIME = 100;
    public static final int SHOOT_ONE_BALL_TIME = 250;
    private ConstantLib(){}
}