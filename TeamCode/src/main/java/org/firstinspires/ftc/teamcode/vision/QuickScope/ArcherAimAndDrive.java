...
@TeleOp(name = "Archer - 全功能驾驶与自动瞄准 (IMU校准)", group = "Main")
public class ArcherAimAndDrive extends LinearOpMode {
    ...
    private Servo LeftPitch, RightPitch, RightBoard, LeftBoard;
    private DcMotorEx LeftShooter, RightShooter, InhaleMotor, IntakeMotor;
    ...
    private final double P_TURN_GAIN = 0.04;
    ...
    private void initializeHardware() {
        // 将所有硬件 get 和 setDirection 等操作放在这里
    ...
    private void controlShooter(LaunchSolution solution) {
        if (solution != null) {
...
//            InhaleMotor.setPower(0.55);
    ...
    private void stopMotors() {
        ...
        LeftBehindMotor.setPower(0);
        RightBehindMotor.setPower(0);
    }
